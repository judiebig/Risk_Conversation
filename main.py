...
def parse_args_and_config():
    ...
    parser.add_argument('--trainer', type=str, default='ConversationGraphTrainer', help='The trainer to execute')
    parser.add_argument('--config', type=str, default='conversation_graph.yml', help='Path to the config file')
    parser.add_argument('--verbose', type=str, default='info', help='Verbose level: info | debug | warning | critical')
    parser.add_argument('--doc', type=str, default='ConversationGraph', help='A string for documentation purpose')
